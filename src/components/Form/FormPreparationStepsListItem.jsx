...
const FormPreparationStepsListItem = ({ step, stepDescription, setStepDescription, className, isAdded = false, error }) => {
    ...
    return (
        <div className={`w-full flex items-center mb-2 preparation-step-animation ${className}`}>
            ...
            <Textarea error={error} disabled={isAdded} cols='40' rows='2' width='w-full' value={stepDescription} setValue={setStepDescription} />
        </div>
    );
};
