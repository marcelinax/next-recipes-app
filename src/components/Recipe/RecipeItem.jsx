...
const RecipeItem = ({title, description, bgImg, category, difficulty, time}) => {
    return (
        <div className='p-6 basis-1/3 max-w-[33.3333%] h-[470px] relative'>
                    ...
                    <div className='w-full border-t-2 border-stone-100 flex h-1/3'>
                        <div className='basis-1/2 flex border-r-2 border-stone-100'>
                            <div className='flex items-center w-full py-5 justify-center '>
                                <IoMdTime className='fill-gray-400' size={16}/>
                                <p className='ml-2 text-sm text-gray-400'>{time} minutes</p>
                            </div>
                        </div>
                        <div className='basis-1/2 flex'>
                            <div className='flex items-center w-full py-5 justify-center'>
                                <IoCellular className='fill-green-400' size={16}/>
